...
class ListaSeries extends Component {
  ...
  /*
    render: 
            ...
            Cada uma das series é um link que redireciona para a 
            página das temporadas da respetiva serie
  
            Caso nao exista nenuma série dispoivel, é aprsentada uma
            mensagem a informar do mesmo
  */
